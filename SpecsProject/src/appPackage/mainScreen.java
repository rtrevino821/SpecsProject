...
public class mainScreen {
	...
	private void initialize() throws URISyntaxException {
		...
		// mainTabbedPane.addTab("Main Dashboard", homeIcon, mainDashTab, "Go to
		// Home Screen");
		...
		// try {
		// String command1 = "C:\\Program Files
		// (x86)\\Google\\Chrome\\Application\\chrome.exe
		// http://automotivation.razorgraphixx.com/";
		...
		//
		// JLabel statusLabel = new JLabel("Current User: " +
		// loginGUI.returnUsername());
		...
		// mainTabbedPane.addTab("Checkout", checkIcon, checkoutTab, "Checkout
		// Customer");
		...
		// }
		// };
		// checkoutTable.getTableHeader().setFont(new Font("Tahoma", Font.BOLD,
		// 18));
		...
		// public void actionPerformed(ActionEvent e) {
		// MessageFormat header = new MessageFormat("AutoMotivation POS
		// System");
		...
		// }
		// };
		// productListTable.getTableHeader().setFont(new Font("Tahoma",
		// Font.BOLD, 18));
		...
		// public void actionPerformed(ActionEvent arg0) {
		// try {
		// String queryAllProducts = "select Name, price, inStock from
		// InventoryList";
		// PreparedStatement pstAllProducts =
		// connection.prepareStatement(queryAllProducts);
		...
		// mainTabbedPane.addTab("Inventory", inventoryIcon, inventoryTab, "Look
		// up parts, price, & inventory");
		...
		// = ?";
		// PreparedStatement pstEngineParts =
		// connection.prepareStatement(queryEngineParts);
		...
		// = ?";
		// PreparedStatement pstAlternators =
		// connection.prepareStatement(queryAlternators);
		...
		// ?";
		// PreparedStatement pstFilters =
		// connection.prepareStatement(queryFilters);
		...
		// mainTabbedPane.addTab("Manager Login", managerIcon, managerPanel,
		// "Manager Login");
		...
		// }
		//
		// //Increments stock quantity when an Item is removed from order
		// summary table
		...
		// }
		//
		// //Decrements stock quantity when an Item is added to order summary
		// table
		...
		// }
		//
		// //While sufficient in stock, copy item from inventory list to order
		// summary
		// public void addItem() {
		// int i = productListTable.getSelectedRow();
		// if (i >= 0) {
		...
		// }
		// } else {
		// JOptionPane.showMessageDialog(null, "Select an item to add from
		// inventory!");
		// }
		// }
		//
		// //While Item is selected and cart not empty, remove from order
		// summary
		...
		// model.removeRow(i);
		// } else {
		// JOptionPane.showMessageDialog(null, "Cart is empty, or No item
		// selected to remove!");
		// }
		// }
		//
		...
		// } catch (IOException e) {
		// System.out.println("Seems there was an error connecting to the
		// internet!"); }
		// } else {}
		// }
		//
		...
		// try {
		// String query = "select * from Managers where username = ? and
		// password = ?";
		...
		// Password");
		// } else {
		// JOptionPane.showMessageDialog(null, "Username and/or Password is not
		// correct!");
		// }
		//
		// rs.close();
